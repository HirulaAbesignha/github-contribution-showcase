function generateTrophy(data, theme) {
  ...
  const cyberpunkSVG = `
    <svg xmlns="http://www.w3.org/2000/svg" width="800" height="250" viewBox="0 0 800 250">
      <rect x="0" y="0" width="800" height="250" fill="#000" />
      <text x="400" y="125" fill="#0ff" text-anchor="middle" font-size="30">CYBERPUNK: ${data.total_contributions}</text>
    </svg>`;

  if (theme === 'cyberpunk') return cyberpunkSVG;
  return neonSVG;
}
